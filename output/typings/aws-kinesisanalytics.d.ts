// Type definitions for aws-sdk - Amazon Kinesis Analytics
...
Kinesis stream or a Firehose delivery stream), you add the relevant
...
in the in-application stream to a data element in the streaming source, with the
option of renaming, casting and dropping columns as desired.
