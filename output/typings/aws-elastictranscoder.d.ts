...
the following values in any sequence:
 ...
 &amp;#42; {count} (Required) : If you want to create thumbnails, you must include 
   ...
   to thumbnail file names. The number indicates where a given thumbnail appears
...
SNS console. &amp;#42; Progressing : The topic ARN for the Amazon Simple Notification Service
   ...
   returned when you created the topic. For more information, see Create a Topic
...
output: &amp;#42; Job:Status and Outputs:Status for all of the outputs is Submitted until
 ...
 * Permissions : A list of the users and/or predefined Amazon S3 groups you want
   ...
   to have. * GranteeType: The type of value that appears in the Grantee object: * 
         Canonical : Either the canonical user ID for an AWS account or an
         origin access identity for an Amazon CloudFront distribution. A
 ...
 * StorageClass : The Amazon S3 storage class, Standard or ReducedRedundancy ,
   ...
   in your Amazon S3 bucket. **/
    ...
    export interface PipelineOutputConfig {
        /** The Amazon S3 bucket in which you want Elastic Transcoder to save the transcoded
files. Specify this value when all of the following are true: &amp;#42; You want to save
   transcoded files, thumbnails (if any), and playlists (if any) together in one
   bucket.
 * You do not want
   ...
   thumbnails, and playlists.
 * You do not want
   to specify the permissions that Elastic Transcoder grants to the files.
 * You want to
 ...
 * **/
        ...
        /** The maximum height of the watermark in one of the following formats: &amp;#42; number of
   pixels (px): The minimum value is 16 pixels, and the maximum value is the
   value of MaxHeight .
 * integer
   percentage (%): The range of valid values is 0 to 100. Use the value of 
...
of MaxHeight . **/
        ...
        /** A value that controls scaling of the watermark: &amp;#42; Fit : Elastic Transcoder scales the watermark so it matches the value that
   you specified in either MaxWidth or MaxHeight without exceeding the other
   value.
 ...
 * Center : The watermark is centered between the top and bottom borders. **/
        ...
        /** VerticalOffsetThe amount by which you want the vertical position of the
...
SNS console. &amp;#42; Progressing : The topic ARN for the Amazon Simple Notification Service
   (Amazon SNS) topic that you want to notify when Elastic Transcoder has
   started to process jobs that are added to this pipeline. This is the ARN that
