...
assessment target. The created resource group is then used to create an
Inspector assessment target.
     ...
     * @error AccessDeniedException   
     */
    createResourceGroup(params: Inspector.CreateResourceGroupRequest, callback?: (err: Inspector.InternalException|Inspector.InvalidInputException|Inspector.LimitExceededException|Inspector.AccessDeniedException|any, data: Inspector.CreateResourceGroupResponse|any) => void): Request;
    /**
     ...
     * @error NoSuchEntityException   
     */
    deleteAssessmentRun(params: Inspector.DeleteAssessmentRunRequest, callback?: (err: Inspector.InternalException|Inspector.InvalidInputException|Inspector.AssessmentRunInProgressException|Inspector.AccessDeniedException|Inspector.NoSuchEntityException|any, data: any) => void): Request;
    /**
     ...
     * @error NoSuchEntityException   
     */
    deleteAssessmentTarget(params: Inspector.DeleteAssessmentTargetRequest, callback?: (err: Inspector.InternalException|Inspector.InvalidInputException|Inspector.AssessmentRunInProgressException|Inspector.AccessDeniedException|Inspector.NoSuchEntityException|any, data: any) => void): Request;
    /**
     ...
     * @error NoSuchEntityException   
     */
    deleteAssessmentTemplate(params: Inspector.DeleteAssessmentTemplateRequest, callback?: (err: Inspector.InternalException|Inspector.InvalidInputException|Inspector.AssessmentRunInProgressException|Inspector.AccessDeniedException|Inspector.NoSuchEntityException|any, data: any) => void): Request;
    /**
     ...
     * @error InvalidInputException   
     */
    describeAssessmentRuns(params: Inspector.DescribeAssessmentRunsRequest, callback?: (err: Inspector.InternalException|Inspector.InvalidInputException|any, data: Inspector.DescribeAssessmentRunsResponse|any) => void): Request;
    /**
     ...
     * @error InvalidInputException   
     */
    describeAssessmentTargets(params: Inspector.DescribeAssessmentTargetsRequest, callback?: (err: Inspector.InternalException|Inspector.InvalidInputException|any, data: Inspector.DescribeAssessmentTargetsResponse|any) => void): Request;
    /**
...
ARN(s).
     ...
     * @error InvalidInputException   
     */
    describeAssessmentTemplates(params: Inspector.DescribeAssessmentTemplatesRequest, callback?: (err: Inspector.InternalException|Inspector.InvalidInputException|any, data: Inspector.DescribeAssessmentTemplatesResponse|any) => void): Request;
    /**
     * Describes the IAM role that enables Inspector to access your AWS account.
     *
     * @error InternalException   
     */
    describeCrossAccountAccessRole(callback?: (err: Inspector.InternalException|any, data: Inspector.DescribeCrossAccountAccessRoleResponse|any) => void): Request;
    /**
     ...
     * @error InvalidInputException   
     */
    describeFindings(params: Inspector.DescribeFindingsRequest, callback?: (err: Inspector.InternalException|Inspector.InvalidInputException|any, data: Inspector.DescribeFindingsResponse|any) => void): Request;
    /**
     ...
     * @error InvalidInputException   
     */
    describeResourceGroups(params: Inspector.DescribeResourceGroupsRequest, callback?: (err: Inspector.InternalException|Inspector.InvalidInputException|any, data: Inspector.DescribeResourceGroupsResponse|any) => void): Request;
    /**
     ...
     * @error InvalidInputException   
     */
    describeRulesPackages(params: Inspector.DescribeRulesPackagesRequest, callback?: (err: Inspector.InternalException|Inspector.InvalidInputException|any, data: Inspector.DescribeRulesPackagesResponse|any) => void): Request;
    /**
     ...
     * @error NoSuchEntityException   
     */
    getTelemetryMetadata(params: Inspector.GetTelemetryMetadataRequest, callback?: (err: Inspector.InternalException|Inspector.InvalidInputException|Inspector.AccessDeniedException|Inspector.NoSuchEntityException|any, data: Inspector.GetTelemetryMetadataResponse|any) => void): Request;
    /**
     ...
     * @error NoSuchEntityException   
     */
    listAssessmentRunAgents(params: Inspector.ListAssessmentRunAgentsRequest, callback?: (err: Inspector.InternalException|Inspector.InvalidInputException|Inspector.AccessDeniedException|Inspector.NoSuchEntityException|any, data: Inspector.ListAssessmentRunAgentsResponse|any) => void): Request;
    /**
     * Lists the assessments run corresponding to assessment template(s) specified by
the assessment template(s)&#x27; ARN(s).
     *
     * @error InternalException   
     * @error InvalidInputException   
     * @error AccessDeniedException   
     * @error NoSuchEntityException   
     */
    listAssessmentRuns(params: Inspector.ListAssessmentRunsRequest, callback?: (err: Inspector.InternalException|Inspector.InvalidInputException|Inspector.AccessDeniedException|Inspector.NoSuchEntityException|any, data: Inspector.ListAssessmentRunsResponse|any) => void): Request;
    /**
     * Lists the ARN(s) of the assessment target(s) within this AWS account. For more
...
.
     ...
     * @error AccessDeniedException   
     */
    listAssessmentTargets(params: Inspector.ListAssessmentTargetsRequest, callback?: (err: Inspector.InternalException|Inspector.InvalidInputException|Inspector.AccessDeniedException|any, data: Inspector.ListAssessmentTargetsResponse|any) => void): Request;
    /**
...
specified by the assessment targets&#x27; ARN(s).
     ...
     * @error NoSuchEntityException   
     */
    listAssessmentTemplates(params: Inspector.ListAssessmentTemplatesRequest, callback?: (err: Inspector.InternalException|Inspector.InvalidInputException|Inspector.AccessDeniedException|Inspector.NoSuchEntityException|any, data: Inspector.ListAssessmentTemplatesResponse|any) => void): Request;
    /**
     * Lists all the event subscriptions for the assessment template specified by the
assessment template ARN. For more information, see SubscribeToEvent and 
UnsubscribeFromEvent .
     ...
     * @error NoSuchEntityException   
     */
    listEventSubscriptions(params: Inspector.ListEventSubscriptionsRequest, callback?: (err: Inspector.InternalException|Inspector.InvalidInputException|Inspector.AccessDeniedException|Inspector.NoSuchEntityException|any, data: Inspector.ListEventSubscriptionsResponse|any) => void): Request;
    /**
...
specified assessment target.
     ...
     */
    previewAgents(params: Inspector.PreviewAgentsRequest, callback?: (err: Inspector.InternalException|Inspector.InvalidInputException|Inspector.AccessDeniedException|Inspector.NoSuchEntityException|Inspector.InvalidCrossAccountRoleException|any, data: Inspector.PreviewAgentsResponse|any) => void): Request;
    /**
     * Registers the IAM role that Inspector uses to list your EC2 instances at the
start of the assessment run or when you call the PreviewAgents action.
     ...
     * @error InvalidCrossAccountRoleException   
     */
    registerCrossAccountAccessRole(params: Inspector.RegisterCrossAccountAccessRoleRequest, callback?: (err: Inspector.InternalException|Inspector.InvalidInputException|Inspector.AccessDeniedException|Inspector.InvalidCrossAccountRoleException|any, data: any) => void): Request;
    /**
     * Removes entire attributes (key and value pairs) from the findings specified by
...
assessment template ARN.
     ...
     * @error NoSuchEntityException   
     */
    setTagsForResource(params: Inspector.SetTagsForResourceRequest, callback?: (err: Inspector.InternalException|Inspector.InvalidInputException|Inspector.AccessDeniedException|Inspector.NoSuchEntityException|any, data: any) => void): Request;
    /**
     * Starts the assessment run specified by the assessment template ARN. For this API
to function properly, you must not exceed the limit of running up to 500
concurrent agents per AWS account.
     *
     * @error InternalException   
     * @error InvalidInputException   
     * @error LimitExceededException   
     ...
     * @error NoSuchEntityException   
     */
    stopAssessmentRun(params: Inspector.StopAssessmentRunRequest, callback?: (err: Inspector.InternalException|Inspector.InvalidInputException|Inspector.AccessDeniedException|Inspector.NoSuchEntityException|any, data: any) => void): Request;
    /**
...
notifications about a specified event to a specified topic.
     ...
     * @error NoSuchEntityException   
     */
    subscribeToEvent(params: Inspector.SubscribeToEventRequest, callback?: (err: Inspector.InternalException|Inspector.InvalidInputException|Inspector.LimitExceededException|Inspector.AccessDeniedException|Inspector.NoSuchEntityException|any, data: any) => void): Request;
    /**
...
notifications about a specified event to a specified topic.
     ...
     * @error NoSuchEntityException   
     */
    unsubscribeFromEvent(params: Inspector.UnsubscribeFromEventRequest, callback?: (err: Inspector.InternalException|Inspector.InvalidInputException|Inspector.AccessDeniedException|Inspector.NoSuchEntityException|any, data: any) => void): Request;
    /**
     ...
     * @error NoSuchEntityException   
     */
    updateAssessmentTarget(params: Inspector.UpdateAssessmentTargetRequest, callback?: (err: Inspector.InternalException|Inspector.InvalidInputException|Inspector.AccessDeniedException|Inspector.NoSuchEntityException|any, data: any) => void): Request;
...
completion time or failure. **/
        ...
        /** Boolean value (true or false) specifying whether the process of collecting data
...
particular generated finding is only added to this list once. **/
...
generated. **/
        ...
        autoScalingGroup?: AutoScalingGroup;
        /** Amazon Machine Image(AMI) ID installed on the EC2 instance where the finding is
generated. **/
        amiId?: AmiId;
    ...
    export interface CreateAssessmentTargetRequest {
        /** The user-defined name identifying the assessment target that you want to create.
...
template. **/
        rulesPackageArns: AssessmentTemplateRulesPackageArnList;
        /** The user-defined attributes that are assigned to every finding generated by the
...
recommendation(s), and the short description(s) that identify the finding(s)
into. **/
        locale?: Locale;
    }
...
Finding data type. **/
        ...
        /** For a record to match a filter, one of the values specified for this data type
property must be the exact match of the value of the autoScalingGroup property
...
Finding data type. **/
        ...
        /** For a record to match a filter, one of the values specified for this data type
property must be the exact match of the value of the rulesPackageArn property of
the Finding data type. **/
        rulesPackageArns?: FilterRulesPackageArnList;
        /** For a record to match a filter, the list of values specified for this data type
property must be contained in the list of values of the attributes property of
the Finding data type. **/
        attributes?: AttributeList;
        /** For a record to match a filter, the value specified for this data type property
...
listed, this parameter is set to &#x27;null&#x27;. **/
    ...
    export interface ListAssessmentRunsRequest {
        /** ARN(s) specifying the assessment template(s) whose assessment run(s) you want to
list. **/
...
listed, this parameter is set to &#x27;null&#x27;. **/
    ...
    export interface ListFindingsRequest {
        /** The ARNs of the assessment run(s) that generate the findings that you want to
list. **/
...
template. **/
    ...
    export interface StartAssessmentRunRequest {
        ...
        assessmentTemplateArn: Arn;
        /** You can specify the name for the assessment run, or it is auto-generated based
on the assessment template name. Must be unique for the assessment template. **/
    ...
    export interface SubscribeToEventRequest {
        /** The ARN of the assessment template used during the event for which you want to
recieve SNS notifications. **/
        resourceArn: Arn;
...
notifications are sent. **/
    ...
    export interface UnsubscribeFromEventRequest {
        /** The ARN of the assessment template used during the event for which you want to
stop recieving SNS notifications. **/
        resourceArn: Arn;
