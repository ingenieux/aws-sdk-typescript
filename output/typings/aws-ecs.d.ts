...
spawns another instantiation of the task in the specified cluster. To update an
...
[https://docs.docker.com/reference/commandline/run/]. By default, containers use
...
running tasks that can be running in a service during a deployment. The maximum
number of tasks during a deployment is the desiredCount multiplied by the 
...
running tasks that must remain running and healthy in a service during a
