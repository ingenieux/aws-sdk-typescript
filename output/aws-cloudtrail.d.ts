...
declare module "aws-sdk" {
    export class CloudTrail {
      ...
      describeTrails(params: CloudTrailDescribeTrailsRequest, callback: (err: CloudTrailUnsupportedOperationException|CloudTrailOperationNotPermittedException|any, data: CloudTrailDescribeTrailsResponse|any) => void): void;
      ...
      listPublicKeys(params: CloudTrailListPublicKeysRequest, callback: (err: CloudTrailInvalidTimeRangeException|CloudTrailUnsupportedOperationException|CloudTrailOperationNotPermittedException|CloudTrailInvalidTokenException|any, data: CloudTrailListPublicKeysResponse|any) => void): void;
      listTags(params: CloudTrailListTagsRequest, callback: (err: CloudTrailResourceNotFoundException|CloudTrailCloudTrailARNInvalidException|CloudTrailResourceTypeNotSupportedException|CloudTrailInvalidTrailNameException|CloudTrailUnsupportedOperationException|CloudTrailOperationNotPermittedException|CloudTrailInvalidTokenException|any, data: CloudTrailListTagsResponse|any) => void): void;
